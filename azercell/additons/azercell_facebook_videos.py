...
page_url = "https://www.facebook.com/azercell/videos"
driver.get(page_url)
...
while len(post_links) < target_posts and scroll_attempts < max_scrolls:
    ...
    # Extract video post links dynamically
...
# Save to Excel
output_path = r'C:\Users\HP\OneDrive\İş masası\facebook_posts_video.xlsx'
